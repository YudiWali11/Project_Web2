!(function (a, i) {
  ...
  (A.tz = C),
    ...
    (A.updateOffset = function (a, i) {
      var e,
        r = A.defaultZone;
      void 0 === a._z && (r && k(a) && !a._isUTC && ((a._d = A.utc(a._a)._d), a.utc().add(r.parse(a), "minutes")), (a._z = r)),
        a._z && ((e = a._z.utcOffset(a)), Math.abs(e) < 16 && (e /= 60), void 0 !== a.utcOffset ? a.utcOffset(-e, i) : a.zone(e, i));
    }),
    (B.tz = function (a, i) {
      if (a) {
